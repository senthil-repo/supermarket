...
kata.supermarket.item
kata.supermarket.product
kata.supermarket.discount
...
Pricing Model:	
 	I understand, that the fully functional supermarket system needs consideration on various aspects 
 	(like price, type, quantity limit, multiple offers, etc..) of discount and offers. 
 	For example, a discount can be applied based on the following additional information:	
 	1) Type of product - E.g cloth, Can of baked beans, Bread, ToothPaste.
 		Here all are sold by ‘unit’, but still the category of these products are different and hence the price can be different.
 		A discount scheme can be applied to any of these categories, but 2 items from the above list may not be combined, as the prices may be different.  	
...
Testing:	
	...
	- I have commented existing test classes for the time being.